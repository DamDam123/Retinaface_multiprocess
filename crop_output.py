...
# imageDir = r'/home/lihongxia/代码/Retinaface-master/data_set/侧脸生成正脸156人/ImageData/*/*.jpg'
# detectResultRootPath = r'/home/lihongxia/代码/Retinaface-master/data_set/侧脸生成正脸156人/detector_result'  # 人脸检测存放目录
# cropImgRootPath = r'/home/lihongxia/代码/Retinaface-master/data_set/侧脸生成正脸156人/crop_Images'  # 人脸裁剪结果存放目录

imageDir = r"/home/lihongxia/face_data/2019_11_08/ImageData/*/*.jpg"
detectResultRootPath = r"/home/lihongxia/face_data/2019_11_08/detector_result"
cropImgRootPath = r"/home/lihongxia/face_data/2019_11_08/crop_Images"

# fe = open("./exist_croppedImgTxt/exist_croppedImg.txt", 'r')
# is_croppedImgList = []
# for imgname in fe.readlines():
...
for j, imgPath in enumerate(imgPaths):
    ...
    # if imgFileName in is_croppedImgList:
    #     print(imgFileName + "已经裁剪")
    #     continue
        ...
        if faces is not None:
            ...
            for i in range(faces.shape[0]):
                ...
                if "-" in angle_dir:
                    ...
                    print("0_")
                    crop_face = imgCopy[y1 - 5: y2 + 5, x1 - 20: x2 + 20]
